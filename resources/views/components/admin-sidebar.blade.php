<div class="flex min-h-screen">
    <aside class="w-72 bg-[#3A3C49] text-white text-base">
        ...
        <!-- Profile -->
        <nav class="mt-6 px-4">
            <div class="p-4 rounded-lg bg-gray-800 border border-gray-700 hover:bg-gray-700 transition duration-200">
                <div class="flex items-center">
                    <img class="h-14 w-14 rounded-full object-cover border-2 border-gray-600"
                         src="{{ asset('images/' . $user->profile_photo_path) }}"
                         alt="Foto Profil Admin">
                    <div class="ml-4">
                        <p class="text-lg font-semibold text-white">Admin User</p>
        ...
        <nav class="mt-8 px-4 space-y-6">
            ...
            <div>
                ...
                <a href="{{ route('dashboard') }}"
                   class="flex items-center px-4 py-3 text-base font-medium rounded-lg text-white hover:bg-gray-700 transition duration-200">
            ...
            <div>
                ...
                <a href="{{ route('admin.users') }}"
                   class="flex items-center px-4 py-3 text-base font-medium rounded-lg {{ request()->routeIs('admin.user') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition duration-200">
