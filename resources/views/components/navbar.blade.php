                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        @auth
                            ...
                            <a href="{{ route('application') }}" class="{{ request()->routeIs('application') ? 'rounded-md bg-zinc-800 px-3 py-2 text-sm font-medium text-white' : 'font-medium text-gray-300 hover:text-white hover:font-semibold transition duration-150 ease-in-out px-3 py-2 text-sm'}}" aria-current="page">Dashboard</a>
                        @endauth
                        @guest
