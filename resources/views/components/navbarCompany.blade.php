    ...
    <div class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3">
            <a href="{{ route('dashboard') }}"
                class="{{ request()->routeIs('dashboard.homeCompany') ? 'block rounded-md bg-zinc-800 px-3 py-2 text-base font-semibold text-white' : 'block rounded-md px-3 py-2 text-base text-gray-300 hover:text-white hover:font-semibold transition duration-150 ease-in-out text-sm' }}">Home</a>
            <a href="{{ route('dashboard.company') }}"
                class="{{ request()->routeIs('dashboard.company') ? 'block rounded-md bg-zinc-800 px-3 py-2 text-base font-semibold text-white' : 'block rounded-md px-3 py-2 text-base text-gray-300 hover:text-white hover:font-semibold transition duration-150 ease-in-out text-sm' }}">Dashboard</a>
        </div>
    </div>
</nav>
<nav class="bg-zinc-700">
