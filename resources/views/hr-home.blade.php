    <x-app-layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-9 gap-6 p-6">
                    ...
                    <div class="lg:col-span-5 bg-gray-200 rounded-xl flex items-center justify-between overflow-hidden">
                        <div class="ml-6 flex-shrink-0">
                            ...
                            <a href="#"
                                class="inline-block border border-gray-700 px-4 py-2 rounded-md hover:text-black hover:font-semibold transition duration-150 ease-in-out text-sm hover:border-2">EXPLORE
                                NOW</a>
                        </div>
                        <div class="flex-shrink-0 h-full flex items-end">
                            <img src="https://media.istockphoto.com/id/1088909778/photo/portrait-of-handsome-smiling-young-man-studio-shot.jpg?s=612x612&w=0&k=20&c=989h9CKzvxQ7-hXUnl7sNeIjJZYkiys7re7083JT4Es="
                    ...
                    <div class="lg:col-span-4 bg-gray-200 rounded-xl p-6 flex flex-col h-full">
                        ...
                        <ul class="space-y-4 text-sm">
                            <li
                                class="flex items-center justify-between bg-white p-3 rounded-md shadow-sm hover:shadow transition">
                        ...
                        <a href="{{ route('hr-dashboard') }}" style="background-color: blue"
                            class="mt-4 bg-sky-500 hover:bg-sky-700 text-white font-medium py-2 px-4 rounded transition duration-150 ease-in-out z-10 inline-block">
                            Go to Dashboard
                        </a>
                ...
                <div class="px-6 mt-6">
                    <div class="flex justify-between items-center mb-2">
                        <h2 class="font-semibold text-lg">Recent Applications</h2>
                        <a href="hr-dashboard"
                            class="text-sm text-neutral-700 hover:text-black hover:font-semibold transition">View All
                            Applications →</a>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <div class="flex items-center gap-3 min-w-0 flex-1">
                                    <div
                                        class="w-12 h-12 rounded-full overflow-hidden border-2 border-gray-300 flex-shrink-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="font-semibold truncate">Sarah Johnson</p>
                                        <p class="text-sm text-gray-500 truncate">Applied for Frontend Developer</p>
                                        <p class="text-xs text-gray-400">2 hours ago</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 flex-shrink-0">
                                    <span
                                        class="bg-blue-100 text-blue-700 text-xs font-semibold px-2 py-1 rounded">NEW</span>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3 min-w-0 flex-1">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="font-semibold truncate">Michael Chen</p>
                                        <p class="text-sm text-gray-500 truncate">Applied for Backend Developer</p>
                                        <p class="text-xs text-gray-400">5 hours ago</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 flex-shrink-0">
                                    <span
                                        class="bg-yellow-100 text-yellow-700 text-xs font-semibold px-2 py-1 rounded">REVIEWED</span>
                                    <button class="text-blue-600 hover:text-blue-800 text-sm font-medium">View</button>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3 min-w-0 flex-1">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="font-semibold truncate">Emily Davis</p>
                                        <p class="text-sm text-gray-500 truncate">Applied for UI/UX Designer</p>
                                        <p class="text-xs text-gray-400">1 day ago</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 flex-shrink-0">
                                    <span
                                        class="bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded">SHORTLISTED</span>
                                    <button class="text-blue-600 hover:text-blue-800 text-sm font-medium">View</button>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3 min-w-0 flex-1">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="font-semibold truncate">David Wilson</p>
                                        <p class="text-sm text-gray-500 truncate">Applied for Marketing Manager</p>
