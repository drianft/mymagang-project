<x-app-layout>
    <div class="bg-[#F9FAFB] min-h-screen py-12">
        <div class="mx-auto max-w-screen-xl px-6">
                ...
                <div class="lg:max-w-xl z-10">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center">
                        ...
                        <button id="search-button"
                                class="mt-3 sm:mt-0 sm:ml-3 bg-[#5A48FA] text-white px-5 py-2 rounded-md hover:bg-indigo-700 transition">
                            Search
                        </button>
                    </div>
                </div>
            ...
            {{-- Job Cards --}}
            <div id="job-grid-container" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                @include('jobs.partials.job_grid', ['posts' => $posts])
            </div>
            ...
            <div class="max-w-screen-xl mx-auto flex items-center justify-center gap-8 mt-10 text-base font-semibold" x-data="{ page: {{ $posts->currentPage() }} }">
                <button x-on:click="page = Math.max(1, page - 1); $refs['page' + page]?.click()"
